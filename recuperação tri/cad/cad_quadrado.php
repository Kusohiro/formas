...
#trcss2:nth-child(even) {
  background-color: #F557FF;
    ...
    <tr id="trcss2">
        ...
        <td><a href="cad_quadrado.php?acao=editar&idQuad=<?php echo $linha['idQuad'];?>&idTab=<?php echo $linha['QidTab'];?>&nome=<?php echo $nome?>">Editar</a></td>
    ...
    ****************************************************************************-->
		<br>
      <form action="../ctrl/ctrl_quadrado.php?idQuad=<?php echo $idQuad; ?>&nome=<?php echo $nome; ?>" method="post">
